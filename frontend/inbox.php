...
<head>
    ...
    <style>
        ...
        .thread span { display:block; font-size:.8rem; color:#555; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
        ...
        textarea { flex:1; resize:none; min-height:50px; border-radius:.5rem; border:1px solid #00bcd4; background:#ffffff; color:#111; padding:.5rem .7rem; }
...
<main class="container">
    ...
    <section class="chat">
        <div class="chat-header">
            <div>
                <strong>@tazio</strong>
                <div style="font-size:.8rem; color:#555;">Last seen 5 min ago</div>
            </div>
        </div>
        <div class="messages">
            <div class="msg them">
